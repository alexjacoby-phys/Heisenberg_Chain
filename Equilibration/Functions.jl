...
begin
    ...
    # function basis_bitstrings(L::Int64, Q::Int64; sparse::Bool=true, boolean::Bool = false)
    #     if sparse == true
    ...
    function basis_bitstrings(L::Int64, Q::Int64; sparse::Bool=true, boolean::Bool=false)
        case1 = ((sparse == true) && (boolean == false))
        case2 = (boolean == true)
        if case1
            states = SparseArrays.spzeros(Int64, binomial(L, Q), L)
        elseif case2
            states = SparseArrays.spzeros(Bool, binomial(L, Q), L)
        else
            states = zeros(binomial(L, Q), L)
        end
        n = 1
